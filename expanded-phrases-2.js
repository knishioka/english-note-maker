...
const EXPANDED_PHRASE_DATA_2 = {
    daily_life: {
        "4-6": [
            ...
            { english: "Good morning sunshine!", japanese: "おはよう、お日様！", situation: "明るい朝の挨拶" },
            ...
            { english: "Don't forget your lunch.", japanese: "お弁当忘れないで。", situation: "持ち物確認" },
            // 日中の活動
        ...
        "7-9": [
            ...
            { english: "Where's my backpack?", japanese: "私のリュックはどこ？", situation: "持ち物探し" },
            ...
            { english: "I'll feed the pet.", japanese: "ペットに餌をあげます。", situation: "ペット世話" },
            { english: "I'll water the plants.", japanese: "植物に水をあげます。", situation: "植物の世話" },
            ...
            { english: "Can I use the tablet?", japanese: "タブレットを使ってもいい？", situation: "デバイス使用" },
            ...
            { english: "I finished my homework.", japanese: "宿題が終わりました。", situation: "宿題完了" },
            { english: "Can you check my work?", japanese: "私の作業を確認してくれる？", situation: "確認依頼" },
            { english: "I need help with math.", japanese: "算数で助けが必要です。", situation: "教科別支援" },
            // 夕方・夜のルーティン
            ...
            { english: "Time to get ready for bed.", japanese: "寝る準備の時間。", situation: "就寝準備開始" },
            { english: "Can I stay up late?", japanese: "遅くまで起きていてもいい？", situation: "就寝延長希望" },
        ...
        "10-12": [
            ...
            { english: "I'll make my own breakfast.", japanese: "自分で朝食を作ります。", situation: "自炊" },
            { english: "I'll be back by 6.", japanese: "6時までに戻ります。", situation: "帰宅時間" },
            { english: "I'm going to study.", japanese: "勉強しに行きます。", situation: "勉強宣言" },
            { english: "I'll do my chores first.", japanese: "先に家事をします。", situation: "家事優先" },
            // 責任と計画
            { english: "I'll manage my time.", japanese: "時間管理をします。", situation: "時間管理" },
            { english: "I need to focus.", japanese: "集中する必要があります。", situation: "集中宣言" },
            { english: "I'll organize my schedule.", japanese: "スケジュールを整理します。", situation: "予定管理" },
            { english: "I'll prepare for tomorrow.", japanese: "明日の準備をします。", situation: "事前準備" },
            { english: "I'll check my assignments.", japanese: "課題を確認します。", situation: "課題確認" },
            // 社交活動
            { english: "Can I go out with friends?", japanese: "友達と出かけてもいいですか？", situation: "外出許可" },
            { english: "I'm going to the library.", japanese: "図書館に行きます。", situation: "図書館利用" },
            { english: "I'll be at my friend's house.", japanese: "友達の家にいます。", situation: "居場所報告" },
            { english: "Can I join the club activity?", japanese: "クラブ活動に参加してもいい？", situation: "活動参加" },
            { english: "I have practice after school.", japanese: "放課後に練習があります。", situation: "練習予定" },
            // デジタルライフ
            { english: "Can I use the computer?", japanese: "コンピューターを使ってもいい？", situation: "PC使用許可" },
            { english: "I need internet for homework.", japanese: "宿題でインターネットが必要です。", situation: "ネット使用理由" },
            { english: "I'll limit my screen time.", japanese: "画面を見る時間を制限します。", situation: "自己管理" },
            { english: "Can I video call my friend?", japanese: "友達とビデオ通話してもいい？", situation: "通話許可" },
            // 健康管理
            { english: "I'll exercise for 30 minutes.", japanese: "30分運動します。", situation: "運動計画" },
            { english: "I need to eat healthier.", japanese: "もっと健康的に食べる必要があります。", situation: "食生活改善" },
            { english: "I'll go to bed early.", japanese: "早く寝ます。", situation: "早寝宣言" },
            { english: "I'll drink more water.", japanese: "もっと水を飲みます。", situation: "水分補給" },
            // 金銭管理
            { english: "Can I have my allowance?", japanese: "お小遣いをもらえる？", situation: "お小遣い要求" },
            { english: "I'm saving for a game.", japanese: "ゲームのために貯金しています。", situation: "貯金目的" },
            { english: "How much does this cost?", japanese: "これはいくらですか？", situation: "価格確認" },
            { english: "I'll buy it with my money.", japanese: "自分のお金で買います。", situation: "自己購入" },
            // 家族との協調
            { english: "I'll help with dinner.", japanese: "夕食の手伝いをします。", situation: "夕食準備協力" },
            { english: "Can we eat together tonight?", japanese: "今夜一緒に食事できる？", situation: "家族団らん" },
            { english: "I appreciate your support.", japanese: "サポートに感謝します。", situation: "家族への感謝" },
            { english: "Let's spend time together.", japanese: "一緒に時間を過ごそう。", situation: "家族時間提案" }
        ]
    },
    feelings: {
        "4-6": [
            ...
            { english: "I can't believe it!", japanese: "信じられない！", situation: "信じられない気持ち" },
            // 安心と快適
        ...
        "7-9": [
            ...
            { english: "The pressure is off.", japanese: "プレッシャーがなくなった。", situation: "重圧解放" },
            // 動機と意欲
            { english: "I'm motivated!", japanese: "やる気がある！", situation: "意欲表現" },
            { english: "I'm determined.", japanese: "決心しています。", situation: "決意表明" },
            { english: "I feel inspired.", japanese: "インスピレーションを感じる。", situation: "感化される" },
            { english: "I'm ready for the challenge!", japanese: "チャレンジの準備ができた！", situation: "挑戦意欲" },
            // 共感と理解
            { english: "I understand how you feel.", japanese: "気持ちがわかります。", situation: "共感表現" },
            { english: "I feel the same way.", japanese: "同じように感じます。", situation: "同感表明" },
            { english: "That must be hard.", japanese: "それは大変でしょうね。", situation: "理解を示す" }
        ],
        "10-12": [
            // 成熟した感情表現
            ...
            { english: "I feel ambivalent.", japanese: "どちらとも言えない気持ち。", situation: "両価性" },
            // 自己認識
            { english: "I'm being too hard on myself.", japanese: "自分に厳しすぎる。", situation: "自己批判認識" },
            { english: "I need to be patient.", japanese: "忍耐が必要です。", situation: "忍耐の必要性" },
            { english: "I'm learning from this.", japanese: "これから学んでいます。", situation: "学習姿勢" },
            { english: "I'm growing as a person.", japanese: "人として成長しています。", situation: "人格成長" },
            // 対人関係の成熟
            { english: "I respect your feelings.", japanese: "あなたの気持ちを尊重します。", situation: "感情尊重" },
            { english: "I empathize with you.", japanese: "共感します。", situation: "深い共感" },
            { english: "I appreciate your perspective.", japanese: "あなたの視点に感謝します。", situation: "視点評価" },
            { english: "I value our relationship.", japanese: "私たちの関係を大切にします。", situation: "関係重視" },
            // ストレス管理
            { english: "I need to calm down.", japanese: "落ち着く必要があります。", situation: "自己鎮静" },
            { english: "I'm taking deep breaths.", japanese: "深呼吸しています。", situation: "リラックス法" },
            { english: "I need some space.", japanese: "少し距離が必要です。", situation: "空間要求" },
            { english: "I'm managing my stress.", japanese: "ストレスを管理しています。", situation: "ストレス管理" },
            // 目標と動機
            { english: "I'm passionate about this.", japanese: "これに情熱を持っています。", situation: "情熱表現" },
            { english: "I'm committed to improving.", japanese: "改善に取り組んでいます。", situation: "改善意欲" },
            { english: "I feel fulfilled.", japanese: "充実感を感じます。", situation: "充実感" },
            { english: "I'm optimistic about the future.", japanese: "将来に楽観的です。", situation: "楽観主義" },
            // 感謝と謙虚
            { english: "I'm grateful for this opportunity.", japanese: "この機会に感謝します。", situation: "機会への感謝" },
            { english: "I'm humbled by your kindness.", japanese: "あなたの優しさに恐縮です。", situation: "謙虚な感謝" },
            { english: "I appreciate everything.", japanese: "すべてに感謝します。", situation: "全般的感謝" },
            { english: "I'm thankful for your support.", japanese: "サポートに感謝しています。", situation: "支援への感謝" },
            // 自己効力感
            { english: "I believe in myself.", japanese: "自分を信じています。", situation: "自己信頼" },
            { english: "I can overcome this.", japanese: "これを乗り越えられます。", situation: "克服意志" },
            { english: "I'm capable of more.", japanese: "もっとできます。", situation: "能力自覚" },
            { english: "I trust my judgment.", japanese: "自分の判断を信頼します。", situation: "判断への自信" },
            // 内省と成長
            { english: "I'm reflecting on my actions.", japanese: "自分の行動を振り返っています。", situation: "自己反省" },
            { english: "I see room for improvement.", japanese: "改善の余地があります。", situation: "改善認識" },
