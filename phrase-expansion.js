...
const PHRASE_LISTS_EXPANSION = {
  ...
  school: {
    ...
    '7-9': [
      // 既存5個に追加
      {
        ...
        japanese: '宿題の期限はいつですか？',
        situation: '締切確認',
      },
      {
        phrase: 'Can I borrow your notes?',
        japanese: 'ノートを借りてもいい？',
        situation: 'ノート貸借',
      },
  ...
  shopping: {
    ...
    '7-9': [
      // 既存5個に追加
      {
        phrase: 'Do you have a smaller size?',
  ...
  travel: {
    ...
    '10-12': [
      // 既存5個に追加
      {
        phrase: 'What time does it depart?',
        japanese: '何時に出発しますか？',
        situation: '時刻確認',
      },
      {
        phrase: 'Is there a connection?',
        japanese: '乗り換えはありますか？',
        situation: '乗換確認',
      },
      {
  ...
  daily_life: {
    ...
    '10-12': [
      ...
      {
        phrase: 'Let me check my schedule',
  ...
  classroom_english: {
    ...
    '7-9': [
      ...
      },
      {
        ...
        japanese: '次は何をすればいいですか？',
        situation: '指示確認',
      },
      {
        phrase: 'I have a different answer',
        japanese: '違う答えがあります',
        situation: '意見相違',
      },
    ],
    '10-12': [
      // 既存5個に追加
      {
        phrase: 'May I elaborate on that?',
        japanese: 'それについて詳しく説明してもいいですか？',
        situation: '詳細説明',
      },
      {
      ...
      {
        phrase: 'Could we discuss this further?',
  ...
  friend_making: {
    ...
    '10-12': [
      // 既存5個に追加
      {
        phrase: 'I value our friendship',
        japanese: '私たちの友情を大切にしています',
        situation: '友情表現',
      },
      {
        phrase: 'Thanks for having my back',
  ...
  cultural_exchange: {
    ...
    '7-9': [
      ...
      {
        phrase: 'We celebrate differently',
    ...
    '10-12': [
      // 既存5個に追加
      {
        phrase: 'I respect your traditions',
        japanese: 'あなたの伝統を尊重します',
        situation: '文化尊重',
      },
      {
      ...
      {
        phrase: 'Let me share my culture',
        japanese: '私の文化を紹介させてください',
        situation: '文化紹介',
      },
    ],
  },
  emergency_situations: {
    ...
    '10-12': [
      ...
      {
        phrase: 'Please contact my guardian',
        japanese: '保護者に連絡してください',
        situation: '保護者連絡',
      },
    ],
  },
...
const NEW_PHRASE_CATEGORIES = {
  ...
  asking_questions: {
    ...
    '7-9': [
      ...
      {
        phrase: 'How do you pronounce this?',
        japanese: 'これはどう発音しますか？',
        situation: '発音確認',
      },
      {
        phrase: 'Is this going to be on the test?',
        japanese: 'これはテストに出ますか？',
        situation: '試験範囲',
      },
      {
        phrase: 'Can you give me an example?',
        japanese: '例を教えてもらえますか？',
        situation: '例示要求',
      },
      {
      ...
      {
        phrase: 'How much time do we have?',
        japanese: 'どのくらい時間がありますか？',
        situation: '時間確認',
      },
      {
        phrase: 'May I ask a question?',
        japanese: '質問してもいいですか？',
        situation: '質問許可',
      },
    ],
    '10-12': [
      {
        ...
        japanese: 'その点について詳しく説明していただけますか？',
        situation: '詳細要求',
      },
      {
      ...
      {
        phrase: 'What are the implications of...?',
        japanese: '〜の意味するところは？',
        situation: '含意確認',
      },
      {
        phrase: 'Could you provide more context?',
        japanese: 'もっと背景を教えていただけますか？',
        situation: '背景要求',
      },
      {
      ...
      {
        phrase: 'How can I improve my...?',
        japanese: 'どうすれば〜を改善できますか？',
        situation: '改善相談',
      },
      {
        phrase: 'What resources do you recommend?',
        japanese: 'どんな資料がお勧めですか？',
        situation: '資料要求',
      },
    ],
  },
  ...
  teamwork_phrases: {
    ...
    '7-9': [
      ...
      {
        phrase: 'We should communicate better',
        japanese: 'もっとコミュニケーションを取るべき',
        situation: '改善提案',
      },
    ],
    '10-12': [
      ...
      {
        phrase: 'I value your contribution',
        japanese: 'あなたの貢献を評価します',
        situation: '貢献認識',
      },
      {
      ...
      {
        phrase: 'We need to coordinate better',
        japanese: 'もっと調整が必要です',
        situation: '連携改善',
      },
      {
      ...
      {
        phrase: 'Our collaboration paid off',
        japanese: '私たちの協力が実を結んだ',
        situation: '成功評価',
      },
    ],
  },
  ...
  problem_solving: {
    ...
    '7-9': [
      ...
      {
        phrase: 'Can we work on this together?',
        japanese: '一緒に取り組める？',
        situation: '協力要請',
      },
      {
      ...
      {
        phrase: 'Is there another way to do this?',
        japanese: '他のやり方はありますか？',
        situation: '代替方法',
      },
    ],
    '10-12': [
      ...
      {
        phrase: 'I need clarification on...',
        japanese: '〜について明確化が必要です',
        situation: '明確化要求',
      },
      {
        phrase: 'What alternatives do we have?',
        japanese: 'どんな選択肢がありますか？',
        situation: '選択肢確認',
      },
      {
      ...
      {
        phrase: 'We need to prioritize',
        japanese: '優先順位をつける必要があります',
        situation: '優先度設定',
      },
      {
  ...
  polite_expressions: {
    ...
    '10-12': [
      {
        phrase: 'I would be grateful if...',
        japanese: '〜していただければ幸いです',
        situation: '丁重な依頼',
      },
      {
      ...
      {
        phrase: 'Thank you for your consideration',
        japanese: 'ご配慮ありがとうございます',
        situation: '配慮への感謝',
      },
      {
      ...
      {
        phrase: 'Your assistance is appreciated',
        japanese: 'ご協力に感謝します',
        situation: '協力感謝',
      },
      {
        phrase: 'Please accept my apologies',
        japanese: 'お詫びを受け入れてください',
        situation: '謝罪要請',
      },
      {
  ...
  study_support: {
    ...
    '7-9': [
      {
        phrase: 'I need to review this',
        japanese: 'これを復習する必要がある',
        situation: '復習必要',
      },
      ...
      {
        phrase: 'Can you check my work?',
        japanese: '私の作業を確認してもらえる？',
        situation: '確認依頼',
      },
    ],
    '10-12': [
      {
        phrase: 'I need to improve my study habits',
        japanese: '勉強習慣を改善する必要があります',
        situation: '習慣改善',
      },
      {
      ...
      {
        phrase: 'This strategy works for me',
        japanese: 'この戦略は私に合っています',
        situation: '方法確立',
      },
      {
        phrase: 'I need to manage my time better',
        japanese: '時間管理を改善する必要があります',
        situation: '時間管理',
      },
      {
      ...
      {
        phrase: 'This concept is challenging',
        japanese: 'この概念は難しいです',
        situation: '難易度認識',
      },
    ],
