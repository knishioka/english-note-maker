...
export const PHONICS_DATA = {
  ...
  op: {
    ...
    label: '-op ファミリー',
    focus: 'op',
    hint: 'o と p の おとの まとまりを みつけよう',
    words: [
      { english: 'hop', japanese: 'ぴょんととぶ' },
      { english: 'mop', japanese: 'モップ' },
      { english: 'top', japanese: 'いちばんうえ' },
  ...
  sh: {
    ...
    label: 'sh の音',
    focus: 'sh',
    hint: 'sh の おとが、ことばの どこに あるか みつけよう',
    words: [
